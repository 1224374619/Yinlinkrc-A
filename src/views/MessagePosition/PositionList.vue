    ...
    <div class="asp-content">
      ...
      >
        <div>
          <div class="loading">
            <i
              style="font-size: 60px; color: #ffbf27"
      ...
      >
        <div>
          <div style="margin: -30px 0 0 0" class="loading-text">
            是否删除该职位？
          </div>
        ...
        <div class="asp-table">
          ...
          <div>
            ...
            >
              ...
              >
                <template slot-scope="scope">{{
                  scope.row.positionState | stateDate
                }}</template>
              </el-table-column>
