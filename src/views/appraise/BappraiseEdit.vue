  ...
  <div class="aspes">
    ...
    <div class="aspes-content">
      <el-form :model="unsteadyForm" ref="unsteadyForm" label-width="110px" class="demo-ruleForm">
        ...
        <el-form-item style="padding:30px 0 40px 100px">
...
export default {
  ...
  methods: {
    ...
    Valid() {
      this.$http
        .put(
          `/review-center/activity/valid/${this.id}/${this.activityId}/${this.unsteadyForm.unsteadyValid}`
        )
        .then(res => {
    ...
    Directly() {
      this.$http
        .put(
          `/review-center/activity/priority/${this.id}/${this.activityId}/${this.unsteadyForm.unsteadyDirectly}`
        )
        .then(res => {
          if (res.data.code == 200) {
            this.appraiseDetail();
      ...
      this.$http
        ...
        .then(res => {
          if (res.data.code == 200) {
            ...
            let address =
              formlist.activityAddress !== null
                ? formlist.activityAddress
                : null;
  ...
  created() {
    ...
    this.activityState = this.$route.query.activityState;
    this.appraiseDetail();
  }
};
</script>
