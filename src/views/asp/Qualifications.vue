...
export default {
  ...
  methods: {
    ...
    Define(tab, event) {
      this.$http
        .put(`/review-center/reviewed/company/${tab.companyId}/cert/${tab.id}/notPass`, {
    ...
    DefineFirst(tab, event) {
      this.$http
        .put(`/review-center/reviewed/company/${tab.companyId}/cert/${tab.id}/pass`)
        .then(res => {
          if (res.data.code == 200) {
            this.ReviewCompany();
          }
    ...
    ReviewCompany() {
      let params = {
        ...
        companyName:this.formInline.CompanyName?this.formInline.CompanyName:null,
        uniformSocialCreditCode:this.formInline.CreditCode?this.formInline.CreditCode:null
      }
      this.$http
        .get("/review-center/reviewed/company/cert", { params: params })
        .then(res => {
          if (res.data.code == 200) {
    ...
    DialogAffirm() {
      this.$http
        .put(`/review-center/reviewed/company/${this.companyId}/cert/${this.id}/rePass`, {
